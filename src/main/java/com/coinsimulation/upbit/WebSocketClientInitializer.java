...
public class WebSocketClientInitializer {
    ...
    private final String ERROR_BACKPRESSURE = "too many requests are in Queue";
    ...
    public WebSocketClientInitializer(WebSocketClient client, TicketRepository ticketRepository, ObjectMapper om) {
        this.client = client;
    ...
    public void upbitListener() {
        client.execute(uri, new UpbitWebSocketHandler(om, ticketRepository))
